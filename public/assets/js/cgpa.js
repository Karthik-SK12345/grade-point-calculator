...
function addInput(divName, counter) {
    for (i = 1; i <= counter; i++) {
        ...
        <div class='col-50'> <label class="label success" style="min-width:100%;color: #042893;text-align: center;font-weight: bolder;padding: 0.5rem; font-family: 'IBM Plex Serif', serif;text-transform: uppercase;"><i class="fa fa-check-circle"
